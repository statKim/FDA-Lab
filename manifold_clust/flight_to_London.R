...
### Get each flight trajectoriese

### Access to Impala shell
session <- osn_connect("statKim")

### 2019-03-01 ~ 2019-06-30
start_period <- date2unixtime("2021-01-01 00:00:00")
end_period <- date2unixtime("2021-7-31 00:00:00")
query <- paste0(
    "SELECT
icao24, firstseen, estdepartureairport, lastseen, estarrivalairport, callsign, day
FROM flights_data4
...
# LLBG: 이스라엘, WSSS: 싱가포르
ind <- which(flight$estarrivalairport == "WSSS")[1:100]   
# i <- ind[3]
flight[i, ]
