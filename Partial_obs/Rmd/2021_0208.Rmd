...
knitr::kable(res.mat, digits = 3, align = "r", caption = "Table 1. Average RMISE of covariance estimation between diagonal and off-diagonal term.") %>% 
...
knitr::kable(res.mat, digits = 3, align = "r", caption = "Table 2. Average RMISE of variances($\\hat{\\sigma}_X^2$) and covariances($\\hat{\\mathbf{C}}$) estimation.") %>% 
    kable_styling("striped", full_width = FALSE, font_size = 14) %>% 
    add_header_above(c(" " = 1, " " = 1, "$\\hat{\\sigma}_X^2$" = 2, "$\\hat{\\mathbf{C}}$" = 2))


knitr::kable(res.mat2, digits = 3, align = "r", caption = "Table 3. Average MISE of covariance estimation between intrapolation($\\mathcal{D}_0$) and extrapolation($\\mathcal{S}_0 \\backslash \\mathcal{D}_0$) parts.") %>% 
    kable_styling("striped", full_width = FALSE, font_size = 14) %>% 
